                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><strong>Empleado:</strong> {{ $nomina->empleado->primer_nombre }}
                            ...
                            {{ $nomina->empleado->segundo_apellido }}</li>
                        ...
                        <li class="list-group-item"><strong>Periodo de liquidacion:</strong>
                            {{ $nomina->liquidacion->fecha_inicio }} - {{ $nomina->liquidacion->fecha_fin }}</li>
                        ...
                        @foreach ($comisionesAplicadas as $comisiona)
                            <ul class="list-group list-group-horizontal list-group-flush">
                                ...
                                <li class="list-group-item d-flex flex-column">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox"
                                            ...
                                            name="esporcentaje[{{ $comisiona->id }}]" value="1"
                                    ...
                                    <input type="number" step="0.01" class="form-control mt -2"
                                        id="percentageInput-{{ $comisiona->id }}" name="porcentaje[{{ $comisiona->id }}]"
                                ...
                                <li class="list-group-item d-flex flex-column">
                                    <strong>Monto</strong>
                                    <input type="number" step="0.01" class="form-control mt-2"
                                        id="amountInput-{{ $comisiona->id }}" name="monto[{{ $comisiona->id }}]"
                                        value="{{ !$comisiona->esporcentaje ? $comisiona->monto : '' }}"
                        ...
                        @foreach ($deduccionesAplicadas as $deducciona)
                            <ul class="list-group list-group-horizontal list-group-flush">
                                ...
                                <li class="list-group-item d-flex flex-column">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox"
                                            ...
                                            name="esporcentaje[{{ $deducciona->id }}]" value="1"
                                ...
                                <li class="list-group-item d-flex flex-column">
                                    <strong>Monto</strong>
                                    <input type="number" step="0.01" class="form-control mt-2"
                                        id="amountInput-{{ $deducciona->id }}" name="monto[{{ $deducciona->id }}]"
                                        value="{{ !$deducciona->esporcentaje ? $deducciona->monto : '' }}"
